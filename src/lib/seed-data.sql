...
('services', 'main-cards', 4, 'Financial Modeling & Valuation', 'Institutional DCF & LBO financial modeling.', 'Deep-dive custom financial modeling for businesses and investors needing institutional valuation clarity.', '', 'Request Valuation', '/contact', 'Institutional', true, '{"features":["DCF & Multiples Valuation","Scenario & Sensitivity Analysis","M&A Impact Modeling"],"color":"#1E7A3A"}'),
